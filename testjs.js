...
// Animation Ã©criture page Accueil
...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est <span style="color: #292929; "><strong>Valentin DARDENNE</strong></span>,')
.pauseFor(1000)
.typeString('<br/>En <strong>Développement </strong> !')
.pauseFor(1000)
.deleteChars(2)
.typeString('<span style="color: blanchedalmond;"> Personnel</span> !')
.pauseFor(1000)
.deleteChars(11)
.typeString('<span style="color: #cac2c9;"> WordPress</span> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: midnightblue;"> JavaScript</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #074632;"> Front-End </span> !')
.pauseFor(1000)
.deleteChars(12)
